...
Type an answer in ALL CAPS in the text box in the first column below. This is limited to 4-letter answers. The time range is `r min(times_clean$puzzle_date)` to `r max(times_clean$puzzle_date)`.
